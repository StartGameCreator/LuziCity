...
class AdminDashboardController extends Controller
{
    public function __invoke(): View
    {
        ...
        $sections = [
            ['label' => 'Monitor de filas', 'description' => 'Acompanhar jobs, retries, dead-letter e atividade dos workers.', 'route' => 'admin.queue-monitor.index', 'icon' => 'dashboard'],
            ['label' => 'Templates do jornal', 'description' => 'Configurar capa, páginas internas, anúncios e créditos do impresso.', 'route' => 'admin.print-templates.index', 'icon' => 'grid'],
            ['label' => 'Jornal impresso', 'description' => 'Criar edições, organizar seções e ordenar as notícias selecionadas.', 'route' => 'admin.print-editions.index', 'icon' => 'news'],
            ['label' => 'Sites', 'description' => 'Domínios, cidades, logos, temas e configurações da rede.', 'route' => 'admin.sites.index', 'icon' => 'grid'],
            ['label' => 'Gestao de Anunciantes', 'description' => 'CRM comercial, contatos, contratos, documentos e historico.', 'route' => 'admin.advertisers.index', 'icon' => 'user'],
            ['label' => 'Central TV Web', 'description' => 'Painel, player, programação, vídeos, roteiros e recortes.', 'route' => 'admin.tv-dashboard', 'icon' => 'video'],
            ['label' => 'Shorts e Reels', 'description' => 'Recortes, legendas, proporções e fila de renderização.', 'route' => 'admin.video-clips.index', 'icon' => 'video'],
            ['label' => 'Roteiros de Vídeo', 'description' => 'IA, cenas, duração, teleprompter e revisão humana.', 'route' => 'admin.video-scripts.index', 'icon' => 'video'],
            ['label' => 'Videoteca', 'description' => 'Vídeos, séries, playlists, categorias, miniaturas e legendas.', 'route' => 'admin.videos.index', 'icon' => 'video'],
            ['label' => 'TV Web', 'description' => 'Canais, YouTube Live, Vimeo, RTMP, embeds e agenda.', 'route' => 'admin.tv.index', 'icon' => 'video'],
            ['label' => 'Central de Rádio e Áudio', 'description' => 'Painel, player, grade, podcasts, áudio IA, publicidade e filas.', 'route' => 'admin.radio-dashboard', 'icon' => 'radio'],
            ['label' => 'Publicidade em Áudio', 'description' => 'Spots, campanhas, programação e relatórios.', 'route' => 'admin.audio-ads.index', 'icon' => 'radio'],
            ['label' => 'Texto para Áudio', 'description' => 'Narrações, vozes, fila, revisão, armazenamento e custos.', 'route' => 'admin.news-narrations.index', 'icon' => 'radio'],
            ['label' => 'Podcasts', 'description' => 'Séries, episódios, capas, áudios e feeds RSS.', 'route' => 'admin.podcasts.index', 'icon' => 'radio'],
            ['label' => 'Estrutura da Rádio', 'description' => 'Emissora, locutores, programas, grade e status no ar.', 'route' => 'admin.radio-structure.index', 'icon' => 'radio'],
        ...
        if (auth()->user()->hasRole('Super Admin')) {
            array_unshift($sections, ['label' => 'Administração Global', 'description' => 'Rede de sites, usuários, custos, saúde e auditoria.', 'route' => 'admin.global.index', 'icon' => 'dashboard']);
        }
