        ...
        <nav class="account-menu" aria-label="Menu de conta">
            @auth
                ...
                @if(auth()->user()->hasAnyRole(['Super Admin', 'Admin', 'Jornalista', 'Colunista']))
                    ...
                    <a href="{{ route('admin.editorial-pitches.index') }}"><x-app-icon name="edit" /> Pautas</a>
                    <a href="{{ route('admin.ai-agents.index') }}"><x-app-icon name="dashboard" /> Agentes</a>
                    <a href="{{ route('admin.editorial-calendar.index') }}"><x-app-icon name="dashboard" /> Calendário</a>
                @endif
