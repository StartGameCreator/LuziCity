...
@section('content')
<section class="admin-page"><div class="section-heading"><div><span class="eyebrow">Execução #{{ $execution->id }}</span><h1>{{ $execution->feature }}</h1></div><a href="{{ route('admin.ai.logs.index') }}">Voltar</a></div>
