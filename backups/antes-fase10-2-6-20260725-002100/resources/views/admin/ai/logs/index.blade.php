...
@section('content')
<section class="admin-page"><div class="section-heading"><div><span class="eyebrow">Auditoria</span><h1>Logs de IA</h1></div><a href="{{ route('admin.ai.costs.index') }}">Custos</a></div>
