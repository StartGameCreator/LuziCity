...
<section class="admin-page ai-dashboard">
    ...
    <nav class="admin-card ai-shortcuts" aria-label="Atalhos da Central Editorial">
        ...
        <a href="{{ route('admin.ai-editorial.index') }}#prompts">Prompts</a>
        <a href="{{ route('admin.ai-editorial.index') }}#providers">Provedores</a>
        <a href="{{ route('admin.news.ai.create') }}#memoria-editorial">Memória editorial</a>
        <a href="{{ route('admin.ai-editorial.index') }}#executions">Custos e logs</a>
