...
class AdminRssImportController extends Controller
{
    ...
    public function import(Request $request): RedirectResponse
    {
        ...
        if (config('luzicity.rss_queue_enabled', true)) {
            ImportRssFeedsJob::dispatch($limit);

            return back()->with('status', 'Importacao RSS enviada para a fila. O processamento continuara em segundo plano.');
        }
