...
{
    private const CONTENT_CACHE_TTL_MINUTES = 5;
    ...
    public function __invoke(): View
    {
        ...
        try {
            $articles = Cache::remember(
                'home:articles:v1',
                now()->addMinutes(self::CONTENT_CACHE_TTL_MINUTES),
    ...
    private function rssCacheKey(): string
    {
        ...
        return 'home:rss-items:'.md5($signature);
    }
