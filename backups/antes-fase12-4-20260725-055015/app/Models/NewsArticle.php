...
class NewsArticle extends Model
{
    ...
    public function versions(): HasMany { return $this->hasMany(NewsArticleVersion::class)->orderByDesc('version'); }
    public function editorialReviews(): HasMany { return $this->hasMany(NewsEditorialReview::class)->latest(); }
